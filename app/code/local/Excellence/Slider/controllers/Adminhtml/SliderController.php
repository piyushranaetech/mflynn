...
class Excellence_Slider_Adminhtml_SliderController extends Mage_Adminhtml_Controller_action {
    ...
    public function saveAction() {
        if ($data = $this->getRequest()->getPost()) {
            ...
            } elseif ($_FILES['filename']['name'] == '' && $this->getRequest()->getParam('id')) {

                $modeles = Mage::getModel('slider/slider')->load($this->getRequest()->getParam('id'));
                $data['filename'] = $modeles->getFilename();
            }
            if ($data['filename']) {
//                if ($data['slider'] == 1) {
//                    $data['slider_name'] = "Top Left";
//                }
//                if ($data['slider'] == 2) {
//                    $data['slider_name'] = "Bottom Left";
//                }
//                if ($data['slider'] == 3) {
//                    $data['slider_name'] = "Near Right";
//                }
//                if ($data['slider'] == 4) {
//                    $data['slider_name'] = "Far Right";
//                }
